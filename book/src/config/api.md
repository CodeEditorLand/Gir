...
To also generate a `Builder` struct for a widget, it needs to be set with the
...
In most other bindings, heap allocations are used for these boxed types too but
